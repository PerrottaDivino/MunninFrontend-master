  ...
  return ( 
    <div className='w-full md:py-20'>
        <Wrapper>
            ...
            <div className='flex flex-col lg:flex-row gap-12 py-10' id="CartContent">
                <div className='flex-[2]' id="CartItem2">
                    <div className='text-lg font-bold'>Cart Items</div>
                    <CartItem />
                    <CartItem />
                    <CartItem />
                    <div className='flex-[1]' id='CartSummary'>
                        <div className='text-lg font-bold'>Summary</div>
                        <div className='p5 my-5 bg-black/[0.05] rounded-xl'>
            ...
            <div className="flex-[2] flex flex-col items-center pb-[50px] md:-mt-14" id="EmptyCard">
                        <Image
                            src="/empty-cart.jpg"
                            width={300}
                            height={300}
